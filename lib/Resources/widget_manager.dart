...
Widget Box({required String text}){
  return Container(
    ...
    child: Text(text,style: getRegularStyle(color: AppColors.grey,fontSize: 15),),
  );
}
...
Widget Button({required String text,Color? background,Color? textColor}){
  return Container(
    ...
    child: Text(text,style: getRegularStyle(color: textColor?? AppColors.white,fontSize: 20),),
  );
}
